#!/bin/bash
#
# Fix organizations table schema by adding missing columns
#
# Usage: ./fix-org-schema.sh
#
...
echo "Adding missing columns to organizations table..."

# Add missing columns if they don't exist
docker-compose exec -T db psql -U postgres -d security_portal << 'EOF'
...
echo "  ./add-org.sh --import-repos"
echo "Or:"
echo "  docker-compose run --rm scanner --target sleepnumber --dry-run"
