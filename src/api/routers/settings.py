...
@router.get("/", dependencies=[Depends(require_permissions("admin:manage"))])
...
@router.post("/", dependencies=[Depends(require_permissions("admin:manage"))])
...
@router.post("/verify/openai", dependencies=[Depends(require_permissions("admin:manage"))])
...
@router.post("/verify/jira", dependencies=[Depends(require_permissions("admin:manage"))])
