    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            <DialogTrigger asChild>
                ...
                >
                    <Sparkles className="h-3 w-3 text-ai-text" />
                ...
                <div className="flex-1 overflow-y-auto space-y-6 py-4">
                    {loading ? (
                        <div className="flex flex-col items-center justify-center py-8 space-y-4">
                            <Loader2 className="h-8 w-8 animate-spin text-ai-text" />
                            <p className="text-sm text-muted-foreground">Analyzing component security posture...</p>
                        </div>
                    ) : error ? (
                        <div className="p-4 text-danger-text bg-danger-soft rounded-md flex items-center gap-2">
