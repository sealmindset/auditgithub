...
export function AskAIDialog({ findingId, trigger, onDescriptionUpdated }: AskAIDialogProps) {
    ...
    const fetchVersionHistory = async () => {
        ...
        try {
            const res = await apiFetch(`${API_BASE}/findings/${findingId}/description-versions`)
            if (res.ok) {
    ...
    const restoreVersion = async (versionId: string) => {
        ...
        try {
            const res = await apiFetch(`${API_BASE}/findings/${findingId}/restore-description`, {
                method: "POST",
...
*This description was enhanced by AI analysis. Review and validate findings before taking action.*`
    ...
    const handleAnalyze = async () => {
        ...
        try {
            ...
            const response = await apiFetch(`${API_BASE}/ai/analyze-finding`, {
                method: "POST",
                headers: { "Content-Type": "application/json" },
